...
module.exports = function(app) {
  ...
  app.post('/addSoldTicket', (req, res) => {
    console.log(req.body);
  	if (req.body.saleType && req.body.paymentMethod && req.body.blankNumber && req.body.blankType && req.body.customerID && req.body.from && req.body.to && req.body.localTax && req.body.payLater && req.body.userID) {
